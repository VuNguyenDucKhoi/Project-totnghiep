                        ...
                        <div class="tourmaster-page-content tourmaster-item-pdlr clearfix">
                                            ...
                                            <div class="tourmaster-tour-booking-bar-summary-people-wrap">
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="tourmaster-head">Số tàu : </span><span
                            ...
                            <div class="tourmaster-tour-payment-content" id="tourmaster-tour-payment-content">
                                <div class="tourmaster-payment-contact-detail-wrap clearfix tourmaster-item-rvpdlr">
                                    ...
                                    <div
                                        class="tourmaster-payment-detail-wrap tourmaster-payment-billing-detail tourmaster-item-pdlr">
                                        <h3 class="tourmaster-payment-detail-title"><i class="fa fa-file-text-o"></i>Thông
                                            Tin Hóa Đơn</h3>
                                        <div class="tourmaster-payment-detail"><span
                                                class="tourmaster-head">Họ tên : </span><span
                                                class="tourmaster-tail">{{$name}}</span></div>
                                        <div class="tourmaster-payment-detail"><span
                                                class="tourmaster-head">Email :</span><span
                                                class="tourmaster-tail">{{$email}}</span>
                                        </div>
                                        ...
                                        <div class="tourmaster-payment-detail"><span
                                                class="tourmaster-head">Quốc gia :</span><span
                                                class="tourmaster-tail">{{$country}}</span>
                                        </div>
                                        <div class="tourmaster-payment-detail"><span
                                                class="tourmaster-head">Địa chỉ :</span><span
                                ...
                                <div class="tourmaster-payment-method-wrap  tourmaster-both-online-payment"><h3
                                        class="tourmaster-payment-method-title">Chọn phương thức thanh toán</h3>
                                     <div class="tourmaster-payment-terms" style="font-size: small">
                                        Chú ý: Đối với thanh toán online. Quý khách vui lòng ghi rõ nội dung: Họ tên - Tên chuyến - Số vé.
                                        <br>*   Quý khách có thể lựa chọn thanh toán đến STK của công ty được ghi dưới phần Thông Tin Thanh Toán.
                                    </div>
                                    <div class="tourmaster-payment-gateway clearfix">

                                        <div class="tourmaster-online-payment-method tourmaster-payment-paypal">
                                            <img src="{{asset('template/upload/vn-pay.png')}}">
                                            <form class="tourmaster-tour-booking-temp"
                                                  action="{{url('/thanh-toan-vnpay')}}"
                                                  method="post">
                                                <input type="hidden" name="invoice_id" value="{{$invoices}}">
                                                <input type="hidden" name="total" value="{{$pays[$chuyen->id] * $chuyen->gia}}">
                                                <input type="submit">
                                                @csrf
                                            </form>
                                        </div>

                                        <div class="tourmaster-online-payment-method tourmaster-payment-credit-card">
                                            <img src="{{asset('template/upload/momo.png')}}">
                                            <form class="tourmaster-tour-booking-temp"
                                                  action="{{url('/thanh-toan-momo')}}"
                                                  method="post">
                                                <input type="hidden" name="invoice_id" value="{{$invoices}}">
                                                <input type="hidden" name="total" value="{{$pays[$chuyen->id] * $chuyen->gia}}">
                                                <input type="submit" value="Thanh toán" name="payUrl">
                                                @csrf
                                            </form>
                                        </div>
                                    </div>
                                    <div class="tourmaster-payment-method-or" id="tourmaster-payment-method-or"><span
                                            class="tourmaster-left" style="width: 274.5px;"></span><span
                                            class="tourmaster-middle">Hoặc</span><span class="tourmaster-right"
                                                                                     style="width: 274.5px;"></span>
                                    </div>
                                    <div class="tourmaster-payment-method-booking">
                                        <a href="{{asset('dat-ve/hoan-thanh-hd')}}"
                                            class="tourmaster-button tourmaster-payment-method-booking-button tourmaster-payment-step"
                                            data-name="payment-method" data-value="booking" data-step="4">Thanh toán tại bến</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
